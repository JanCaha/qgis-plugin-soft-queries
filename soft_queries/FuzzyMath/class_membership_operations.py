...
class FuzzyAnd:
    ...
    def fuzzyAnd(a: FuzzyMembership, b: FuzzyMembership, type: fuzzyAnds):
        ...
        if type not in FUZZY_AND_NAMES:
            raise ValueError(
                "Unknown value `{}` for `fuzzy and`. Known types are `{}`.".format(
...
class PossibilisticAnd(PossibilisticOperation):
    ...
    @staticmethod
    def possibilisticAnd(
        a: PossibilisticMembership, b: PossibilisticMembership, type: fuzzyAnds
    ):
        ...
        return PossibilisticMembership(
            method_to_call(a_poss, b_poss).membership,
...
class FuzzyOr:
    ...
    def Hamacher(a: FuzzyMembership, b: FuzzyMembership) -> FuzzyMembership:
        return FuzzyMembership(
            (a.membership + b.membership) / (1 + (a.membership * b.membership))
        )
    ...
    def fuzzyOr(a: FuzzyMembership, b: FuzzyMembership, type: fuzzyOrs):
        ...
        if type not in FUZZY_OR_NAMES:
            raise ValueError(
                "Unknown value `{}` for `fuzzy or`. Known types are `{}`.".format(
...
class PossibilisticOr(PossibilisticOperation):
    ...
    @staticmethod
    def possibilisticOr(
        a: PossibilisticMembership, b: PossibilisticMembership, type: fuzzyOrs
    ):
